...
public class FileSetSelector implements FileSelector {
    private final static Logger log = LoggerFactory.getLogger(FileSetSelector.class);
    ...
    public boolean includeFile(FileSelectInfo fileInfo) throws Exception {
        ...
        String relativeName = fileInfo.getBaseFolder().getName()
                .getRelativeName(fileInfo.getFile().getName());
