...
import static org.metaborg.spoofax.core.project.SpoofaxProjectConstants.LANG_SDF;
import static org.metaborg.spoofax.core.project.SpoofaxProjectConstants.LANG_STRATEGO;
...
public class SpoofaxMetaBuilder {
    ...
    @Inject
    public SpoofaxMetaBuilder(IResourceService resourceService,
            IDependencyService dependencyService,
            ILanguagePathService languagePathService,
            SpoofaxBuilder builder) {
    ...
    public void generateSources(MetaBuildInput input) throws Exception {
        Iterable<ILanguage> compileLanguages =
                dependencyService.compileDependencies(input.project);
    ...
    public static class MetaBuildInput {
        ...
        public MetaBuildInput(IProject project,
