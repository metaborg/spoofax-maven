...
class SpoofaxGradleConstants {
    ...
    static final def SPOOFAX_PLUGIN_NAME = "spoofax"
    ...
    static final def SPOOFAX_JAVA_SOURCESET_NAME = "spoofax"

    static final def SPOOFAX_INITPROJECT_TASK_NAME = "initSpoofaxProject"
    static final def SPOOFAX_COMPILE_TASK_NAME = "compileSpoofax"
    static final def SPOOFAX_METACOMPILE_PRE_TASK_NAME = "compileSpoofaxMetaPre"
    static final def SPOOFAX_METACOMPILE_POST_TASK_NAME = "compileSpoofaxMetaPost"
    static final def SPOOFAX_METACOMPILE_TASK_NAME = "compileSpoofaxMeta"
